        ...
        jqswfupload: function (opstions) {
            ...
            function createuploadbox() {
                var temp = "<div class='fm-upload-flash-box' style='width: " + ops.buttonWidth + "px;float: left;margin-right: 5px;'>" +
                    "<span id='" + buttonid + "'></span></div><button class='btn static-upload' " + (ops.autoUpload ? "style='display:none;'" : "") + " >" + ops.upbuttonText + "</button><ul class='qq-upload-list' " + (!ops.showStart ? "style='display:none;'" : "") + "></ul><div style='clear: both;'></div>";
                $(objthis).append(temp);
            }
            //绑定上传按钮
