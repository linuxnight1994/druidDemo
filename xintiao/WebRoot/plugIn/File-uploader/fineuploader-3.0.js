...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            typeError: "{file} 上传文件类型不符: {extensions}",
            sizeError: "{file} 上传文件过大,最大为： {sizeLimit}",
            minSizeError: "{file} 上传文件过小，最小为： {minSizeLimit}",
            emptyError: "{file} 上传文件为空，请选择最少一个文件",
            noFilesError: "没有上传文件",
            onLeave: "文件正在上传,如果你现在离开上传将会取消"
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._options.button ? '<div class="qq-upload-button btn "><div style="line-height:26px;">{uploadButtonText}</div></div>' : '') +
            (!this._options.autoUpload? '<div class="qq-doupload-button btn" style="margin-left: 5px;" >上传</div>':'')+
        ...
        fileTemplate: '<li  >' +
            ...
            '<div  class="qq-progress-bar-box" ><span class="qq-progress-bar"  ></span></div>' +
