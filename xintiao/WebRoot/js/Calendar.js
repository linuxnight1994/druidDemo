...
var Calendar = {
    ...
    Init: function(weekDayNames, dateLinkMappings, settings) {
        if (!weekDayNames || weekDayNames.length && weekDayNames.length != 7) {
            this.weekDayNames[1] = "<b>周一</b>";
            this.weekDayNames[2] = "<b>周二</b>";
            this.weekDayNames[3] = "<b>周三</b>";
            this.weekDayNames[4] = "<b>周四</b>";
            this.weekDayNames[5] = "<b>周五</b>";
            this.weekDayNames[6] = "<b>周六</b>";
            this.weekDayNames[7] = "<b>周日</b>";
        }
        else {
    ...
    _RenderTitle: function(month, year) {
        ...
        //日期
        ht.push("<tr>");
        ht.push("<th colspan='7' style='width:100%;'><div class='pre_month' style='float:left;width:10%;text-align:center;' id='", this.containerId, "_prevMonth' title='上一月'>上一月</div><div style='float:left;text-align:center;width:80%'>", year, "年", month, "月</div><div class='nex_month' style='float:right;width:10%; text-align:center;' id='", this.containerId, "_nextMonth' title='下一月'>下一月</div></th>");
        ht.push("</tr>");
        //星期
        ht.push("<tr>");
        for (var i = 0; i < 7; i++) {
