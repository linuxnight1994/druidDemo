...
/**
 * deprecated: 大屏显示wocketServer服务
 * 
 * date 2015-03-11
 * 
 * @author sharkTang
 */
@ServerEndpoint(value = "/bigPing")
@Component
public class PuFaBigPingWebSocketServer extends UtryWebSocketServer {
	private Logger logger_;

	public PuFaBigPingWebSocketServer() {
		logger_ = Logger.getLogger(this.getClass().getName());
	}

	@Override
	public String getSentData() {
		return DataFindAction.sendString;
	}
