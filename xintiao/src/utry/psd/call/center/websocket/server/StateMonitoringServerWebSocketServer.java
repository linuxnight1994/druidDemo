...
import utry.psd.call.center.test.StateMonitoringDataTest;
 ...
 * @author sharkTang
 */
@ServerEndpoint(value = "/stateMonitoringServer")
@Component
public class StateMonitoringServerWebSocketServer extends UtryWebSocketServer {
	private Logger logger_;

	public StateMonitoringServerWebSocketServer() {
	...
	public String getSentData() {
		...
		List<Object> rtvos =StateMonitoringDataTest
				.makeStateMonitoringBoVoList(StateMonitoringDataTest
						.makeStateMonitoringDate());
